...
class BulkDownloader:
    ...
    def get_tweets_csv_for_this_user(self, screen_name, output_file_name):
        ...
        outtweets = [
            [tweet.id_str, tweet.created_at, str(tweet.text.encode("utf-8").decode('utf8')), tweet.retweet_count,
             tweet.favorite_count, tweet.in_reply_to_status_id_str, tweet.in_reply_to_screen_name, screen_name] for
            tweet in alltweets]
